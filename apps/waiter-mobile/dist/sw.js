...
self.addEventListener("push", (event) => {
  ...
  self.registration.showNotification(data.title || "DineX Captain", {
    body: data.body || "",
    icon: "/icon-captain.svg",
    badge: "/icon-captain.svg",
    tag: data.tag || "dinex-captain"
  });
});
