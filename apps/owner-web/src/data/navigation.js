...
export const navigation = [
  ...
  { id: "whatsapp-ordering",   label: "WhatsApp Ordering",    path: "/whatsapp-ordering",     mode: "react" },
...
export const navGroups = [
...

  {
    ...
    items: [
      ...
      { id: "whatsapp-ordering", label: "WhatsApp Ordering", path: "/whatsapp-ordering", icon: "chat" },
